    ...
    return (
        <div className="w-full border border-indigo-700 rounded-xl">
            ...
            <div className="mt-2 p-4">
                <div className="w-full h-full bg-indigo-700 rounded-xl p-2 text-ellipsis overflow-y-auto overflow-x-auto h-64 scrollbar scrollbar-thumb-white scrollbar-track-indigo-700">
